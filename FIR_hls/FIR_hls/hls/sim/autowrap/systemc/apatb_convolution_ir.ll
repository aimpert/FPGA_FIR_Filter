; ModuleID = '/home/alex/Scratch/FPGA_FIR_Filter/FIR_hls/FIR_hls/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_convolution_ir(float* noalias nocapture nonnull readonly %x, float* noalias nocapture nonnull readonly %h, i64 %filterLength, float* noalias nocapture nonnull %y, i64 %outputLength) local_unnamed_addr #0 {
entry:
  %x_copy = alloca float, align 512
  %h_copy = alloca float, align 512
  %y_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %x, float* nonnull align 512 %x_copy, float* nonnull %h, float* nonnull align 512 %h_copy, float* nonnull %y, float* nonnull align 512 %y_copy)
  call void @apatb_convolution_hw(float* %x_copy, float* %h_copy, i64 %filterLength, float* %y_copy, i64 %outputLength)
  call void @copy_back(float* %x, float* %x_copy, float* %h, float* %h_copy, float* %y, float* %y_copy)
  ret void
}
...
declare void @apatb_convolution_hw(float*, float*, i64, float*, i64)
...
declare void @convolution_hw_stub(float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull readonly, i64, float* noalias nocapture nonnull, i64)

define void @convolution_hw_stub_wrapper(float*, float*, i64, float*, i64) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1, float* null, float* %3)
  call void @convolution_hw_stub(float* %0, float* %1, i64 %2, float* %3, i64 %4)
  call void @copy_in(float* null, float* %0, float* null, float* %1, float* null, float* %3)
  ret void
}
