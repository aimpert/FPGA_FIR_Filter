...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /tools/Xilinx/Vivado/2024.2/tps/lnx64/gcc-8.3.0/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /tools/Xilinx/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/tools/Xilinx/Vivado/2024.2/tps/lnx64/gcc-8.3.0
LFLAG += --gcc-toolchain=/tools/Xilinx/Vivado/2024.2/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/FIRFilter.cpp_pre.cpp.tb.o : FIRFilter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling FIRFilter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
